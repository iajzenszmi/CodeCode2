...
!      integer p11,p12,p21,p22,p31,p32,p41,p42,p51,p52,p61,p62,p71,p72,p81,p81,p91
       integer p12,p22,p32,p42,p52,p62,p72,p82,p92
       integer p11,p21,p31,p41,p51,p61,p71,p81,p91
                 integer a1, a2, a3, a4, a5, a6, a7,a8,a9, hq
                   ...
                   do 30 a5 = p51, p52
                    do 20 a6  = p61, p62
                     do 10 a7 = p71, p72
                      do 5  a8 =p81,p821
                       do 3  a9 = p91, p92
      hq = 10*a1+10*a2+10*a3+10*a4+10*a5+10*a6+10*a7+10*a8+10*a9
                          h(a1,a2,a3,a4,a5,a6,a7,a8,a9) = hq
...
! 100           continue
      write(6,1000) recnt 
      write(6,1010) a1-1,a2-1,a3-1,a4-1,a5-1,a6-1,a7-1,a8-1,a9-1
1000        format (" ",f20.0)
1010   format("+",i10,i10,i10,i10,i10,i10,i10,i10,i10)
          return
          end subroutine
