/*  elevator control and reporting  for 8 floors 2 lifts and 100 passengers */
...
let elevator = {
  ...
  move: function(destinationFloor) {
    console.log('Elevator is moving from floor ${this.currentFloor} to floor ${destinationFloor}');i
